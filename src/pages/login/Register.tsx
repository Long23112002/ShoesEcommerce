...
import '../../styles/loading-custom.css'
...
const Register = () => {
    ...
    const handleRegister = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        const {valid, errors} = validateForm(userToCreate, confirmPassword);
        ...
        try {
            const response = await register(userToCreate);
            setLoading(true);
                ...
                <div className="row">
                    ...
                    <div className="col-12 d-flex justify-content-center  mt-3 mb-3">
                        <span className="text-login" style={{fontSize: 28}}>
                            Enter your username to join us or sign up.
                        </span>
                    </div>
                    ...
                    <div className="col-12 d-flex justify-content-center ">
                        <div className="form mobie-form" style={{width: '40%'}}>
                            ...
                            <div className="w-100 mt-3">
                                <button type="submit" className="w-100 btn btn-outline-dark" onClick={handleRegister}>
                                    {isLoading ? (
                                        <div className='d-flex justify-content-center align-content-center'>
                                            <CircularProgress size={20}/>
                                            <span
                                                style={{marginLeft: '20px', marginBottom: '5px'}}>Registering...</span>
                                        </div>
                                    ) : (
                                        'Register'
                                    )}
